...
const useAnimationLoop = (
  ...
  }, [trackRef, targetVelocity, seqWidth, seqHeight, isHoveredRef, hoverSpeed, isVertical]);
};
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    useAnimationLoop(trackRef, targetVelocity, seqWidth, seqHeight, isHoveredRef, effectiveHoverSpeed, isVertical);
    ...
    const rootClasses = useMemo(
      () =>
        cx(
          'relative group',
          isVertical ? 'overflow-hidden h-full inline-block touch-pan-x' : 'overflow-x-hidden touch-pan-y',
          '[--logoloop-gap:32px]',
        ...
        const content = isNodeItem ? (
          <span
            className={cx(
              ...
              scaleOnHover &&
                'transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/item:scale-120 will-change-transform'
            )}
