...
class App {
  ...
  onWheel(e: Event) {
    ...
    const w = wheelEvent as unknown as Record<string, number>;
    const delta = wheelEvent.deltaY || w.wheelDelta || w.detail;
